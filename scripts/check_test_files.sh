...
EXCLUDE_FILES=(
    ...
    "src/core/settings/app_env_config.py"
    "src/core/settings/app_settings.py"
    "src/core/settings/common_settings.py"
    "src/core/settings/db_settings.py"
    "src/core/settings/redis_settings.py"
